...
require(['root/config'],function(Config){
	...
	require(['jquery', 'core/app-utils', 'core/addons-internal', 'core/app', 'core/router', 'core/region-manager', 'core/stats', 'core/phonegap/utils'],
			function ($, Utils, Addons, App, Router, RegionManager, Stats, PhoneGap) {
			...
			var launch = function() {
				...
				require(Addons.getJs('init','before'),function(){
					...
					App.initialize( function() {
						...
						RegionManager.buildDebug( function(){
								...
								RegionManager.buildLayout(function(){
									...
									RegionManager.buildHeader(function(){
										...
										require(Addons.getJs('theme','before'),function(){
											...
											function(error){
												Utils.log('Error : theme/js/functions.js not found or Javascript error in theme/js/functions.js', error);
											});
										});
									});
